...
const theme='dark';
function applyTheme(){document.documentElement.dataset.theme='dark';document.documentElement.style.colorScheme='dark';localStorage.setItem('dchsTheme','dark')}
applyTheme();
...
document.addEventListener('safeLangChanged',e=>{game.lang=e.detail.lang==='kz'?'kz':'ru';if(!game.running)gameReset();applyTheme()});gameReset();
